...
@Component({
  selector: 'app-expand-employee-table',
  templateUrl: './expand-employee-table.component.html',
  styleUrls: ['./expand-employee-table.component.css'],
...
export class ExpandEmployeeTableComponent implements OnInit, AfterViewInit {
